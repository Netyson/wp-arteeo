...
<div class="aside-container">
	<ul class="aside-menu__nav">
		<li class="aside-menu__item  aside-menu__item--active" aria-haspopup="true">
			<a href="/metronic/preview/demo1/index.html" class="aside-menu__link ">
				<span class="aside-menu__link-icon">
					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="aside-svg-icon">
						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<polygon points="0 0 24 0 24 24 0 24"></polygon>
		...
		<li class="aside-menu__item" aria-haspopup="true">
					<a href="/metronic/preview/demo1/index.html" class="aside-menu__link ">
						<span class="aside-menu__link-icon">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="aside-svg-icon">
								<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
